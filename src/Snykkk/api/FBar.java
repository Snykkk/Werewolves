...
public class FBar {
	...
	public static void sendActionBar(Player p, String message) {
		FBar_1_12.sendActionBar(p, message);
	}

	public static void sendTitleBar_(Player p, String title, String subtitle) {
		FBar_1_12.sendTitleBar(p, title, subtitle);
	}

	public static void sendTitleBar(Player p, String title, String subtitle) {
		sendTitle(p, 0, 60, 0, title, subtitle);
	}
